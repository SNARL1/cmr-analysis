...
captures <- read_csv(here::here("data","clean", "50783_capture.csv"))
surveys <- read_csv(here::here("data","clean", "50783_survey.csv"))
```
...
```
```{r read-model}
model_50783 <- read_rds(here::here("out", "model", "50783_model.rds"))
```
