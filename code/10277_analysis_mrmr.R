...
captures <- "./data/clean/captures_upper.csv" %>% read_csv
translocations <- "./data/clean/translocations_upper.csv" %>% read_csv
surveys <- "./data/clean/surveys_upper.csv" %>% read_csv
...
write_rds(mod, "./out/model_upper_mrmr.rds", "xz", compression = 9L)
...
p1 / p2 / p3
ggsave("./out/upper_mrmr_plots.png", width = 6.5, height = 7.2)
