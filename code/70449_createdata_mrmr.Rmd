...
translocation_70449_mrmr %>% write_csv(here::here("data", "clean", "70449_translocation.csv"))
```
```{r read_cleaned_translocation_data, message=FALSE}
translocation_70449 <- read_csv(here::here("data", "clean", "70449_translocation.csv")) %>% 
