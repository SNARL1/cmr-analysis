...
assert_that(!any(nchar(translocation_70414$pit_tag_ref) != 9))
...
translocation_70414 %>% filter(grepl("dead", comment_relocate_frog))
...
rm(con)
```
CMR and visual surveys retained because post-translocation surveys in which no frogs were found were recorded as VES. 
...
70414 is the primary site and was surveyed during each secondary period. 
...
# Check for records containing pit tags shorter than 15 characters (or 9 for early sites)
assert_that(!any(nchar(capture_70414$pit_tag_ref) != 9))
