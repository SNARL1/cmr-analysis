...
#### Survival
Overall, survival is low. However, the survival of the 2021 cohort looks to be between 50-100% between the two lakes, suggesting a high probability that group will persist long-term. The survival of the 2022-2024 cohorts is, by 2026, almost 0%. Survival of all cohorts appears slightly higher in 10114. Across the first winter, the frogs sources from 10055 and released in 2022-2024 had survival substantially less than 50%, suggesting a high probability that group of frogs will face extinction in the long-run.

As of summer 2026, we have gathered from other data summaries that the gist is that the reintroduced frogs that remain in the lakes are all descendants of *only* the first cohort, in 2021 from 10037. At first glance, we have no evidence that frogs released in 2022-2024, all from 10055, have survived. Summaries from other recovery projects suggest that frogs from 10055 have had lower than expected survival at other sites as well, but this is curious. 

#### Reproduction
In VES in 2026, modest numbers of RASI tadpoles and subadults were observed especially in 10109, so this is also promising. 150+ RASI tadpoles in 10109, and 30+ in 10114. However, the original cohort of adults has senesced after several years and there will need to be new breeding-age adults (hopefully from the 2026 cohort) to continue fueling reproduction. 
