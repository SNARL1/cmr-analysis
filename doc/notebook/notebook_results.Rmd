...
*updated: 8/23/2026 by TomCSmith*

#### Summary 
These sites have been subject to recovery efforts since 2021, when the first cohorts of *Rana sierrae* were released here. In most regards, the frog reintroductions and survey efforts are replicated in the two adjacent - but unconnected - sites. Frogs have generally been treated similarly/identically prior to reintroduction, reintroductions occurred concurrently, and very similar survey schedules have been achieved. It may thus be fair to attribute any major differences between outcomes of reintroductions at these two sites to the sites themselves (there are some notable differences in habitat), or chance because it is just two lakes.  

It is important to note that the reintroduced frogs have history. Firstly, they are sourced from two persistent populations (10037 and 10055) in nearby lakes basins within the same watershed. Secondly, those frogs were *sometimes* put through the so-called immune priming process, but only in some years (only 2022, 2023). Thirdly, although there were two source populations, due to constraints of tadpole collection and captive rearing, only one source population was used in each reintroduction year (10037: 2021, 2026; 10055, 2022 - 2024; no reintroduction in 2025). By extension of that, only the frogs from 10055 received immune priming (prior exposure to Bd).

As of summer 2026, we have gathered from other data summaries that the gist is that the reintroduced frogs that remain in the lakes are all descendants of *only* the first cohort, in 2021 from 10037. At first glance, we have no evidence that frogs released in 2022-2024, all from 10055, have survived. Summaries from other recovery projects suggest that frogs from 10055 have had lower than expected survival at other sites as well, but this is curious. 

2025 and 2026 saw increases in natural recruitment at lake 10109, suggesting the population is becoming established. 

Note that as of August 2026, the CMR models do not include individual or survey covariates (Bd load, survey condutions). However, given the very low survival especially among 10055 frogs, covariates may be of little use in establishing drivers of survival in these populations.

FIGURES:
10109 (including neighboring sites)
![](../../out/plots/10109_mrmr_plots.png){width=75%}

10114 (including neighboring sites)
![](../../out/plots/10114_mrmr_plots.png){width=75%}

#### Survival
Overall, survival is low. However, the first-winter survival of the 2021 cohort - all sourced from 10037 - looks to be between 50-100% between the two lakes, suggesting a high probability that group will persist long-term - and notably, most of the frogs seen in 2025-2026 are still that group. The survival of the 2022-2024 cohorts is, by 2026, almost 0%. Survival of all cohorts appears slightly higher in 10114. The frogs released in 2022-2024 - all sourced from 10055 - had first-winter survival substantially less than 50%, suggesting a high probability that group of frogs will face extinction in the long-run.

As of summer 2026, we have gathered that the reintroduced frogs that remain in the lakes are all descendants of *only* the first cohort, in 2021 from 10037. Summaries from other recovery projects suggest that frogs from 10055 have had lower than expected survival at other sites as well. 

#### Reproduction
In VES in 2026, modest numbers of RASI tadpoles and subadults were observed especially in 10109, so this is also promising. 150+ RASI tadpoles in 10109, and 30+ in 10114. However, the original cohort of adults has largely senesced after several years and new breeding-age adults (hopefully from the 2026 cohort) are needed to continue fueling reproduction. 

#### Recruitment
In 10109, natural recruitment began in the summer of 2025, and has been substantially higher in 2026. 10114 saw its first recruited individual on 17 June 2026. 

#### Population Size
At 10109, the population looks to be 25-50 individuals in 2026. At 10114, it is probably 10-20 individuals at this time. 
